    ...
    <>
      ...
      >
        <div className="md:w-[86%] w-[90%] sm:h-max flex flex-col gap-6">
          ...
          <Tabs
            defaultValue="tab1"
            className="flex flex-col h-full gap-12  p-0.5"
          >
            <TabsList className="lg:w-[50%] md:w-[60%] w-[80%] mx-auto flex gap-2 justify-center h-14 bg-purple-100 rounded-md p-2">
              <TabsTrigger
                value="tab1"
            ...
            <TabsContent value="tab1">
              ...
              >
                <motion.div
                  ...
                  className="cursor-pointer bg-purple-100 rounded-3xl filter shadow-md"
                >
                  <h6 className="text-2xl font-bold text-primary mb-4 dark:text-white text-nowrap">
                  ...
                  <li>
                      ...
                      including servers, networks, storage systems, and virtual
                      environments.
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      languages (e.g., Python, PowerShell) and automation tools
                      (e.g., Ansible, Puppet).
                    </li>
                  </ul>
                </motion.div>
       ...
       className="cursor-pointer bg-purple-100 rounded-3xl filter shadow-md"
            ...
            <TabsContent
              value="tab2"
              className="md:w-[80%] w-[95%] mx-auto md:mb-0 mb-5"
            >
                  ...
                  <div className="flex items-center flex-col sm:flex-row">
                    <div className="flex justify-start w-full mx-auto items-center">
                      <div className="w-full sm:w-1/2 sm:pr-8">
                        <div className="bg-purple-100 p-4 rounded shadow group hover:bg-black cursor-pointer ease-in duration-150">
