...
export default function Footer() {
  return (
    ...
    <footer className="bg-custom-pink flex flex-col  justify-center items-center text-black gap-2  dark:bg-gray-900">
      {/* border */}
      <div className="w-full border-t-2 border-purple-100"></div>
      {/* Container for icons with spacing between them */}
      <div className="md:hidden flex gap-4 dark:text-pink-200 mt-2">
      ...
      <div className="text-center text-sm font-semibold dark:text-pink-200">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="font-semibold hover:text-pink-800 hover:underline inline-flex items-center gap-1 dark:text-pink-400 dark:opacity-100 dark:hover:text-pink-200"
      >
        Source code on <FaGithub />
      </a>

      {/* Made with Heart icon and text */}
      <div className="inline-flex items-center gap-1 font-bold dark:text-pink-200 mb-2">
