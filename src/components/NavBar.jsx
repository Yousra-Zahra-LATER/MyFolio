...
export const NavBar = () => {
    ...
    return (
        <>
            ...
            <nav className="flex justify-between items-center w-[90%] mx-auto py-4">
                ...
                <div className="hidden md:flex items-center gap-10 font-semibold">
                    {navBarlinks.map((link, index) => (
                        <li key={index} className="cursor-pointer hover:text-[#807279] list-none">
                            {link.name}
                        </li>
                    ))}
                </div>
                ...
                <div className="hidden md:flex items-center">
                    ...
                    <button className="bg-pink-500 text-white px-4 py-2 rounded-md mr-4">
                        Portfolio
                    </button>
                </div>
                ...
                <div className="md:hidden flex items-center">
                    ...
                    <button className="bg-pink-500 text-white px-4 py-2 rounded-md mr-4">Portfolio</button>
            ...
            {menuOpen && (
                <div className="md:hidden fixed top-0 w-full h-[48%]  bg-custom-pink shadow-lg z-10 p-14 flex flex-col">
